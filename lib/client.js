window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function extractOwnerRepo(spec) {
      ...
      const doInstall = (spec) => {
        ...
        return fetch("/plugin-store/install", {
          ...
          if (res && res.ok) {
            ...
            fetch("/plugin-store/install-meta").then((r) => r.json()).then((m) => setInstallMeta(m && m.meta && typeof m.meta === "object" ? m.meta : {}));
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-root", "aria-busy": loading, children: [
        ...
        catalog ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-heading", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-heading-actions", children: [
              category === "installed" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "ps-update-all", onClick: updateAll, disabled: updatableCount === 0, children: [
                t("updateAll"),
                "\uFF08",
                updatableCount,
                "\uFF09"
          ...
          category === "installed" && partial && fetched < total ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "ps-status", children: "\u6B63\u5728\u52A0\u8F7D\u5168\u90E8\u63D2\u4EF6\uFF0C\u5DF2\u5B89\u88C5\u5217\u8868\u5C06\u81EA\u52A8\u8865\u5168\u2026" }) : null,
          ...
          pageEntries.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "ps-cards", children: pageEntries.map((entry) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: "ps-card", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-card-top", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-card-badges", children: [
    ...
    var zh = {
      ...
      close: "\u5173\u95ED",
      manualInstall: "\u624B\u52A8\u5B89\u88C5",
      manualHint: "\u7C98\u8D34\u5B89\u88C5\u547D\u4EE4\u6216\u5305\u540D\uFF0C\u5982 dsh plugin add github:owner/repo\u3001@scope/pkg\u3001github:owner/repo#subdir",
      invalidUrl: "\u65E0\u6CD5\u8BC6\u522B\u7684\u5B89\u88C5\u547D\u4EE4\u6216\u5305\u540D",
      installedFilter: "\u5DF2\u5B89\u88C5",
      uninstall: "\u5378\u8F7D",
      uninstalling: "\u5378\u8F7D\u4E2D\u2026",
    ...
    var en = {
      ...
      manualHint: "Paste an install command or package spec, e.g. dsh plugin add github:owner/repo, @scope/pkg, github:owner/repo#subdir",
      invalidUrl: "Unrecognized install command or package spec",
