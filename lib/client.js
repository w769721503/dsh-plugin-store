    ...
    function StoreTab({ t }) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-root", "aria-busy": loading, children: [
        ...
        error ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-failure", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", onClick: () => window.location.reload(), children: t("retry") })
        ] }) : null,
        catalog ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-heading", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
              ...
              " ",
              facetCounts.indexed,
              fetched > 0 && fetched < total ? ` \xB7 \u663E\u793A ${fetched}` : "",
              filtered.length !== facetCounts.total ? ` \xB7 ${filtered.length}` : ""
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-toolbar", children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "ps-select", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", { value: sort, onChange: (e) => setSort(e.currentTarget.value), "aria-label": t("sort"), children: SORTS.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: s.id, children: s.zh }, s.id)) })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "ps-tags", role: "toolbar", "aria-label": t("allTags"), children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "ps-chip", "data-active": tag === "all", onClick: () => setTag("all"), children: [
              t("allTags"),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "ps-chip-count", children: facetCounts.total })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", { type: "button", className: "ps-chip", "data-active": tag === "indexed", onClick: () => setTag("indexed"), children: [
              t("indexed"),
          ...
          sorted.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "ps-cards", children: sorted.map((entry) => {
